            ...
            <tbody class="table__tbody">
                <?php foreach ($eventos as $evento) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td">
                            <?php 
                                // Mostrar el día y la hora en el formato adecuado
                                echo $evento->dia->nombre . ", " . $evento->hora->hora;
                            ?>
                        </td> 
                        <td class="table__td">
                            <?php 
                                // Mostrar el nombre y apellido del ponente
                                echo $evento->ponente->nombre . " " . $evento->ponente->apellido;
                            ?>
                        </td> 
